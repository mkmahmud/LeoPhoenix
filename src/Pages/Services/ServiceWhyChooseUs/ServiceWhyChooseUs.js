...
const ServiceWhyChooseUs = ({ data }) => {

    const { icon, title, text } = data;

    return (
        <div className='h-[275px] w-[369px] bg-white text-left my-7 shadow-[0px 0px 0px rgba(0, 0, 0, 0.25)] rounded-[20px] mx-auto pl-[53px] pr-[23px]' >
