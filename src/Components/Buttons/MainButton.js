...
const MainButton = ({ content, path }) => {
    return (
        ...
        <Link to={path} style={{fontFamily:`'Inter', sans-serif`}} class="m-2 relative inline-flex items-center justify-start px-6 py-2 overflow-hidden font-medium transition-all bg-[#FF5B00] rounded-xl hover:bg-white group">
